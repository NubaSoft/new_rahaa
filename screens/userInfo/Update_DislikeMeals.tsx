...
const Update_DislikeMeals = (params: any) => {
  ...
  useEffect(() => {
    setSelectMealsDisliked(params.route.params?.dislikemeals)
    getDislikeMeals()
  }, [])
  ...
  const onNextButtonPress = () => {
    ...
    axios
      .post(
        config.baseURL + "/api/meals/dislikemeals",
        {
          meal_ids: array_for_disliked_meal,
        },
        {
          headers: {
...
export default Update_DislikeMeals
