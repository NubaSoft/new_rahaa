...
const Update_Allergy = (params: any) => {
  ...
  useEffect(() => {
    setSelectAllergy(params.route.params?.dislikeallergyitems)
    getAllergy()
  }, [])
  ...
  const onNextButtonPress = () => {
    ...
    axios
      .post(
        config.baseURL + "/api/meals/dislikeallergyitems",
        {
          item_ids: array_for_allergy,
        },
        {
          headers: {
