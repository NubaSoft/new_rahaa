...
const DislikeIngredient = (params: any) => {
  ...
  const onNextButtonPress = () => {
    ...
    registerData.disliked_item_ids = array_for_disliked_item
    params.navigation.navigate("DislikeMeals", { registerData: registerData })
  }
    ...
    <View style={styles.body}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            params.navigation.navigate("DislikeMeals", {
